    ...
    <>
      ...
      <section className="font-mono h-[800px] mx-auto bg-red-200 text-center">
        ...
        <div className='flex'>
          ...
          <div className='text-[40px] mt-10'>
            If You have a 
            <div className='h-[43px] overflow-hidden inline-block whitespace-pre'>
              <div className='text-purple-700 animate-[show_5s_linear_infinite]'> Pro </div>
      ...
      <section id="about" className="px-20 md:px-64 p-96 mx-auto bg-blue-200 text-center">
        <div className='font-mono text-sm md:text-lg text-red-600 animate-[move_1.2s_ease-in-out_infinite]'>Take Your Training to the Next Level!</div>
        <br />
