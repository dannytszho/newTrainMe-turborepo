    ...
    extend: {
      ...
      keyframes: {
        ...
        '0%': {
         ...
         '30%': {
            'text-shadow': '3px 3px 0 text-[#f49b90], 6px 6px 0 text-[#f28b7d] , 9px 9px text-[#f07a6a]'
          },
         '40%': {
            'text-shadow': '3px 3px 0 text-[#f49b90], 6px 6px 0 text-[#f28b7d], 9px 9px text-[#f07a6a], 12px 12px 0 text-[#ee6352]'
          },
         '50%': {
            'text-shadow': '3px 3px 0 text-[#f49b90], 6px 6px 0 text-[#f28b7d], 9px 9px text-[#f07a6a], 12px 12px 0 text-[#ee6352]'
          },
